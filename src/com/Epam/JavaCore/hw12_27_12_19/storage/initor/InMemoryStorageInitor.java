package com.Epam.JavaCore.hw12_27_12_19.storage.initor;
...
public class InMemoryStorageInitor implements StorageInitor {
    ...
    @Override
    public void initStorage(InitFrom initFrom) {
        switch (initFrom) {
            case FILE:
                if (filePath == null) {
                    throw new InitorFilePathIsNullException();
                }
                FromFileInitor.initDataFromFile(filePath);
                break;
            default:
                initCargos();
                initCarriers();
